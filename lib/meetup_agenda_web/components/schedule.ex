      ...
      <section class="select_date">
        <div>
          <h3>
            ...
            {#for {w,p} <- Enum.with_index(@day_positions)}
              <Label>
                <Checkbox unchecked_value="nil" checked_value={p+1} click={"day_position", target: "#month_view"} /> {w}
              </Label>
              <br>
          {/for}
        </div>
        <div>
          <h3>
            ...
            {#for d <- @week_days}
              <Label>
                <Checkbox checked_value={d} click={"week_day", target: "#month_view"}/> {d}<br>
              </Label>
            <br>
          {/for}
        </div>
        ...
        <div>
          ...
          {#for y <- 2022..2025}
              <Label>
                <Checkbox checked_value={y}
                click={"year", target: "#month_view"}/> {y}
              </Label>
            <br>
          {/for}
        </div>
